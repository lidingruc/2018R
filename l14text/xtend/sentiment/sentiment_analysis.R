...
# load data
urls = "https://raw.githubusercontent.com/victorneo/Twitter-Sentimental-Analysis/master/"
happy = readLines(paste(urls, "happy.txt", sep = ""))
sad = readLines(paste(urls, "sad.txt", sep = ""))
happy_test = readLines(paste(urls, "happy_test.txt", sep = ""))
sad_test = readLines(paste(urls, "sad_test.txt", sep = ""))
