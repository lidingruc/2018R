# 2018R
这里是基于中国人民大学《数据科学与社会研究》课程资料的修改得到的北京大学《互联网与社会研究：技术基础》的课程资料。修改后的教学和练习活动进一步围绕两本开源的核心教材。

互联网特别是移动互联网对社会生活产生了巨大的影响，非常值得社会学去关注和研究。采用传统的研究方法当然也能得到很好的研究成果，但如果能深入理解构建起互联网的技术与信息基础，并能利用这些技术和信息对互联网基础上发生的人类活动及组织运作进行研究，有可能会更深刻一步。即便你不做技术专家，也应该懂点技术。
