#### Script needed to run Gelman & Hill (2007) - Ch 5
library(foreign)
library(arm)
brdata<-read.dta("http://www.stat.columbia.edu/~gelman/arm/examples/nes/nes5200_processed_voters_realideo.dta", convert.factors=FALSE)
